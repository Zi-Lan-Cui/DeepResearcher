...
from deepresearcher.agents.supervisor.directives import (
    ...
    async def _run_agent_loop(
        ...
        async def delegate(topic: str) -> dict[str, object]:
                ...
                return _reported(
                    {
                        ...
                        "instruction": ROUND_BUDGET_EXHAUSTED_INSTRUCTION,
                    }
                )
            ...
            if execution.task_result.provider_exhausted:
                ...
                direction_report["instruction"] = PROVIDER_EXHAUSTED_INSTRUCTION
